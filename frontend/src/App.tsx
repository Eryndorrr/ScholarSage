...
import { FileText, FolderOpen, MessageSquare, Plus, Trash2, MessageCircle } from 'lucide-react'
      ...
      <MainLayout>
        ...
        <div className="flex-1 flex overflow-hidden">
            ...
            {selectedCollection ? (
              <>
                <div className="p-4 border-b bg-white">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-700">文档管理</span>
              ...
              <div className="flex-1 flex items-center justify-center text-gray-400">
                <div className="text-center">
                  ...
                  <p className="text-sm">选择知识库查看文档</p>
                </div>
              </div>
            )}
          </aside>
          ...
          <main className="flex-1 flex">
            ...
            {/* 对话列表 */}
            {selectedCollection && (
              <aside className="w-64 bg-gray-50 border-l flex flex-col">
